...
grammar = {
    ...
    'forStmt': [TokenType.FOR, TokenType.LEFT_PAREN, ('varDecl', 'exprStmt', TokenType.SEMICOLON),
                Option('expression'), TokenType.SEMICOLON, Option('expression'), TokenType.RIGHT_PAREN, 'statement'],
    'ifStmt': [TokenType.IF, TokenType.LEFT_PAREN, 'expression', TokenType.RIGHT_PAREN, 'statement', 
               Option([TokenType.ELSE, 'statement'])],
    'block': [TokenType.LEFT_BRACE, Star('declaration'), TokenType.RIGHT_BRACE],
    'exprStmt': ['expression', TokenType.SEMICOLON],
    'printStmt': [TokenType.PRINT, 'expression', TokenType.SEMICOLON],
    'whileStmt': [TokenType.WHILE, TokenType.LEFT_PAREN, 'expression', TokenType.RIGHT_PAREN, 'statement'], 
    'expression': 'assignment',
    'assignment': ([TokenType.IDENTIFIER, TokenType.EQUAL, 'assignment'], 'logic_or'),
    'logic_or': ['logic_and', Star([TokenType.OR, 'logic_and'])],
    'logic_and': ['equality', Star([TokenType.AND, 'equality'])],
